 ...
 * <p>
 * this header refer to this project https://github.com/zx391324751/ElmRefreshViewDemo
 */

public class ElmRefreshHeader extends View implements PtrHandler {
    ...
    public ElmRefreshHeader(Context context) {
        super(context);
    }

    public ElmRefreshHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ElmRefreshHeader(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        MOVE_RADIUS = dipToPx(getContext(), 45);
        initPaint();
        initBitmap();
        initSize();
        initElmFoodList();
